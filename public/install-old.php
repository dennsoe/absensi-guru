    ...
    <div class="installer-container">
        ...
        <div class="card step" id="step5">
            ...
            <div class="card-body text-center py-5">
                ...
                <div class="mt-4">
                    <a href="<?= rtrim(str_replace('/public', '', dirname($_SERVER['SCRIPT_NAME'])), '/') ?>/login"
                ...
                <div class="mt-3">
                    <small class="text-muted">
                        ...
                        <code>install.php, install-check.php, install-test-db.php, install-import-db.php,
                            install-create-admin.php</code>
                    </small>
                </div>
            </div>
        </div>
