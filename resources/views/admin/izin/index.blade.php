                        ...
                        <tbody>
                            @forelse($izins as $izin)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $izin->jenis_izin === 'sakit' ? 'danger' : ($izin->jenis_izin === 'cuti' ? 'info' : 'warning') }}-subtle text-{{ $izin->jenis_izin === 'sakit' ? 'danger' : ($izin->jenis_izin === 'cuti' ? 'info' : 'warning') }}">
