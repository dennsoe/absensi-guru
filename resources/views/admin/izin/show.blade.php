                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="fw-semibold">
                                    <span
                                        class="badge bg-{{ $izin->jenis_izin === 'sakit' ? 'danger' : ($izin->jenis_izin === 'cuti' ? 'info' : 'warning') }}-subtle text-{{ $izin->jenis_izin === 'sakit' ? 'danger' : ($izin->jenis_izin === 'cuti' ? 'info' : 'warning') }} fs-6">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-icon bg-{{ $izin->status_approval === 'approved' ? 'success' : 'danger' }}-subtle text-{{ $izin->status_approval === 'approved' ? 'success' : 'danger' }} rounded-circle">
                                        <i
                                            class="bi bi-{{ $izin->status_approval === 'approved' ? 'check-circle' : 'x-circle' }} fs-4"></i>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <div class="fw-semibold">
                                        {{ $izin->status_approval === 'approved' ? 'Disetujui' : 'Ditolak' }} oleh
                                    ...
                                    @endif
                                    @if ($izin->status_approval === 'approved' && $izin->guruPengganti)
                    ...
                    <div class="card-body">
                        ...
                        <div class="small">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span
                                    class="badge bg-success-subtle text-success">{{ ucfirst($izin->guru->status) }}</span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
