                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <div class="btn-group" role="group">
                            <a href="{{ route('admin.laporan.export-pdf.per-kelas', ['kelas_id' => $kelas->id, 'bulan' => $bulan, 'tahun' => $tahun]) }}"
                                class="btn btn-danger" target="_blank" title="Export ke PDF">
                                <i class="bi bi-file-pdf"></i> Export PDF
                            </a>
                            <a href="{{ route('admin.laporan.export-excel.per-kelas', ['kelas_id' => $kelas->id, 'bulan' => $bulan, 'tahun' => $tahun]) }}"
